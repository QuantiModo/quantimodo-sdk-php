...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://app.quantimo.do/api';
     ...
     * @var string
     */
    protected $userAgent = "Swagger-Codegen/4.6.5/php";
    ...
    public static function toDebugReport()
    {
        ...
        $report .= '    OpenAPI Spec Version: 4.6.5' . PHP_EOL;
        $report .= '    SDK Package Version: 4.6.5' . PHP_EOL;
