...
use \ArrayAccess;
/**
 * TrackingReminderPending Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class TrackingReminderPending implements ArrayAccess
{
    /**
    ...
    /**
      * $id id for the specific PENDING tracking remidner
      * @var int
      */
    protected $id;
    
    /**
      * $tracking_reminder_id id for the repeating tracking remidner
      * @var int
      */
    protected $tracking_reminder_id;
    ...
    public function __construct(array $data = null)
    {
        if ($data != null) {
            $this->id = $data["id"];
            $this->tracking_reminder_id = $data["tracking_reminder_id"];
    ...
    {
        return $this->tracking_reminder_id;
    }
    ...
    public function setTrackingReminderId($tracking_reminder_id)
    {
        ...
        $this->tracking_reminder_id = $tracking_reminder_id;
        return $this;
    }
