...
class State implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'hover' => '\QuantiModo\Client\Model\Hover'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['hover'] === null) {
            $invalid_properties[] = "'hover' can't be null";
        }
    ...
    /**
     * Gets hover
     * @return \QuantiModo\Client\Model\Hover
     */
    ...
    /**
     * Sets hover
     * @param \QuantiModo\Client\Model\Hover $hover
     * @return $this
     */
