...
class Scope implements ArrayAccess
{
    ...
    {
        $this->container['scalar'] = isset($data['scalar']) ? $data['scalar'] : null;
    }
    ...
    {
        return $this->container['scalar'];
    }

    /**
     * Sets scalar
     * @param string $scalar Example: user_likes
     * @return $this
     */
    public function setScalar($scalar)
    {
        $this->container['scalar'] = $scalar;
