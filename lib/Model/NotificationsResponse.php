...
class NotificationsResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'notifications' => '\QuantiModo\Client\Model\Notification[]',
        'description' => 'string',
        'summary' => 'string',
     ...
     * Gets notifications
     *
     * @return \QuantiModo\Client\Model\Notification[]
     */
     ...
     * Sets notifications
     *
     * @param \QuantiModo\Client\Model\Notification[] $notifications notifications
     *
     * @return $this
     */
