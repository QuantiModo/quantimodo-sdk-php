...
class StudyText implements ModelInterface, ArrayAccess
{
     ...
     * Sets study_design
     *
     * @param string $study_design Ex: This study is based on data donated by  21 QuantiModo users. Thus, the study design is equivalent to the aggregation of 21 separate n=1 observational natural experiments.
     *
     * @return $this
     */
