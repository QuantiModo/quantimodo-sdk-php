...
class MessagesApi
{
     ...
     * @return \QuantiModo\Client\Model\MessagesMessagesResponse[]
     */
     ...
     * @throws \QuantiModo\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \QuantiModo\Client\Model\MessagesMessagesResponse[], HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\QuantiModo\Client\Model\MessagesMessagesResponse[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\QuantiModo\Client\Model\MessagesMessagesResponse[]',
     ...
     * @throws \QuantiModo\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \QuantiModo\Client\Model\MessagesNoticesResponse[]
     */
     ...
     * @throws \QuantiModo\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \QuantiModo\Client\Model\MessagesNoticesResponse[], HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\QuantiModo\Client\Model\MessagesNoticesResponse[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\QuantiModo\Client\Model\MessagesNoticesResponse[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \QuantiModo\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \QuantiModo\Client\Model\MessagesRecipientsResponse[]
     */
     ...
     * @throws \QuantiModo\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \QuantiModo\Client\Model\MessagesRecipientsResponse[], HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\QuantiModo\Client\Model\MessagesRecipientsResponse[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\QuantiModo\Client\Model\MessagesRecipientsResponse[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
