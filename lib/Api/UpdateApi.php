...
class UpdateApi
{
     ...
     */
    public function updatesGet($access_token = null, $user_id = null, $connector_id = null, $number_of_measurements = null, $success = null, $message = null, $created_at = null, $updated_at = null, $limit = null, $offset = null, $sort = null)
    {
        list($response, $statusCode, $httpHeader) = $this->updatesGetWithHttpInfo ($access_token, $user_id, $connector_id, $number_of_measurements, $success, $message, $created_at, $updated_at, $limit, $offset, $sort);
        return $response; 
    }


    /**
     * updatesGetWithHttpInfo
     *
     * Get all Updates
     *
     * @param string $access_token User&#39;s OAuth2 access token (optional)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function updatesGetWithHttpInfo($access_token = null, $user_id = null, $connector_id = null, $number_of_measurements = null, $success = null, $message = null, $created_at = null, $updated_at = null, $limit = null, $offset = null, $sort = null)
    {
        
  
        // parse inputs
        $resourcePath = "/updates";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
     ...
     *
     * @param string $access_token User&#39;s OAuth2 access token (optional)
     * @param \Swagger\Client\Model\Update $body Update that should be stored (optional)
     * @return \Swagger\Client\Model\InlineResponse20028
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function updatesPost($access_token = null, $body = null)
    {
        list($response, $statusCode, $httpHeader) = $this->updatesPostWithHttpInfo ($access_token, $body);
        return $response; 
    }


    /**
     * updatesPostWithHttpInfo
     *
     * Store Update
     *
     * @param string $access_token User&#39;s OAuth2 access token (optional)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function updatesPostWithHttpInfo($access_token = null, $body = null)
    {
        ...
        try {
            ...
            return array(\Swagger\Client\ObjectSerializer::deserialize($response, '\Swagger\Client\Model\InlineResponse20028', $httpHeader), $statusCode, $httpHeader);
            
        } catch (ApiException $e) {
            switch ($e->getCode()) { 
            case 200:
                $data = \Swagger\Client\ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\InlineResponse20028', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
            }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function updatesIdGet($id, $access_token = null)
    {
        list($response, $statusCode, $httpHeader) = $this->updatesIdGetWithHttpInfo ($id, $access_token);
        return $response; 
    }


    /**
     * updatesIdGetWithHttpInfo
     *
     * Get Update
     *
     * @param int $id id of Update (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function updatesIdGetWithHttpInfo($id, $access_token = null)
    {
        
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling updatesIdGet');
        }
  
        // parse inputs
        $resourcePath = "/updates/{id}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
     ...
     * @param int $id id of Update (required)
     * @param string $access_token User&#39;s OAuth2 access token (optional)
     * @param \Swagger\Client\Model\Update $body Update that should be updated (optional)
     * @return \Swagger\Client\Model\InlineResponse2002
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function updatesIdPut($id, $access_token = null, $body = null)
    {
        list($response, $statusCode, $httpHeader) = $this->updatesIdPutWithHttpInfo ($id, $access_token, $body);
        return $response; 
    }


    /**
     * updatesIdPutWithHttpInfo
     *
     * Update Update
     *
     * @param int $id id of Update (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function updatesIdPutWithHttpInfo($id, $access_token = null, $body = null)
    {
        
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling updatesIdPut');
        }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function updatesIdDelete($id, $access_token = null)
    {
        list($response, $statusCode, $httpHeader) = $this->updatesIdDeleteWithHttpInfo ($id, $access_token);
        return $response; 
    }


    /**
     * updatesIdDeleteWithHttpInfo
     *
     * Delete Update
     *
     * @param int $id id of Update (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function updatesIdDeleteWithHttpInfo($id, $access_token = null)
    {
        
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling updatesIdDelete');
        }
