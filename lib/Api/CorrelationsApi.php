...
class CorrelationsApi
{
    ...
    public function v1AggregatedCorrelationsGetWithHttpInfo($access_token = null, $effect = null, $cause = null, $correlation_coefficient = null, $onset_delay = null, $duration_of_action = null, $last_updated = null, $limit = null, $offset = null, $sort = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\Correlation[]'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\Correlation[]', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\Correlation[]', $e->getResponseHeaders());
    ...
    public function v1AggregatedCorrelationsPostWithHttpInfo($body, $access_token = null)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 400:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\JsonErrorResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * Delete vote.
     *
     * @param \Swagger\Client\Model\VoteDelete $body The cause and effect variable names for the predictor vote to be deleted. (required)
     * @param string $access_token User&#39;s OAuth2 access token (optional)
     *
     * @return \Swagger\Client\Model\CommonResponse
     * @throws \Swagger\Client\ApiException on non-2xx response
     ...
     * Post or update vote.
     *
     * @param \Swagger\Client\Model\PostVote $body Contains the cause variable, effect variable, and vote value. (required)
     * @param string $access_token User&#39;s OAuth2 access token (optional)
     *
     * @return \Swagger\Client\Model\CommonResponse
     * @throws \Swagger\Client\ApiException on non-2xx response
