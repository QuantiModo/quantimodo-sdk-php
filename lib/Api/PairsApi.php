...
class PairsApi
{
    ...
    {
        list($response) = $this->v1PairsCsvGetWithHttpInfo($cause, $effect, $access_token, $cause_source, $cause_unit, $delay, $duration, $effect_source, $effect_unit, $end_time, $start_time, $limit, $offset, $sort);
        return $response;
    }
    ...
    {
        list($response) = $this->v1PairsGetWithHttpInfo($cause, $effect, $access_token, $cause_source, $cause_unit, $delay, $duration, $effect_source, $effect_unit, $end_time, $start_time, $limit, $offset, $sort);
        return $response;
    }
