...
class ConnectApi {
   ...
   * @return void
   */
   public function v1Connect.jsGet($t) {
      
      // verify the required parameter 't' is set
      if ($t === null) {
        throw new \InvalidArgumentException('Missing the required parameter $t when calling v1Connect.jsGet');
      }
      ...
      // query params
      if($t !== null) {
        $queryParams['t'] = $this->apiClient->toQueryValue($t);
      }
