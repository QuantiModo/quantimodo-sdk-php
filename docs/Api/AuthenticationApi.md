...
# **getAccessToken**
> getAccessToken($client_secret, $grant_type, $code, $response_type, $scope, $client_id, $redirect_uri, $state)
...
try {
    $api_instance->getAccessToken($client_secret, $grant_type, $code, $response_type, $scope, $client_id, $redirect_uri, $state);
} catch (Exception $e) {
...
------------- | ------------- | ------------- | -------------
 **client_secret** | **string**| This is the secret for your obtained clientId. We use this to ensure that only your application uses the clientId.  Obtain this by creating a free application at [https://app.quantimo.do/api/v2/apps](https://app.quantimo.do/api/v2/apps). |
...
> getOauthAuthorizationCode($client_secret, $response_type, $scope, $client_id, $redirect_uri, $state)
...
try {
    $api_instance->getOauthAuthorizationCode($client_secret, $response_type, $scope, $client_id, $redirect_uri, $state);
} catch (Exception $e) {
...
try {
    $api_instance->postGoogleIdToken();
} catch (Exception $e) {
